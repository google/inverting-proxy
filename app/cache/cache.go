...
func NewCachingStore(s types.Store) types.Store {
	return &cachingStore{
		BackingStore: s,
	}
}
...
func (c *cachingStore) WriteRequest(ctx context.Context, r *types.Request) error {
...
func (c *cachingStore) ReadRequest(ctx context.Context, backendID string, requestID string) (*types.Request, error) {
	var r types.Request
...
func (c *cachingStore) WriteResponse(ctx context.Context, r *types.Response) error {
	if len(r.Contents) < cacheEntrySizeLimit {
		memcache.Gob.Set(ctx, &memcache.Item{
...
func (c *cachingStore) ReadResponse(ctx context.Context, backendID, requestID string) (*types.Response, error) {
...
func (c *cachingStore) AddBackend(ctx context.Context, backend *types.Backend) error {
	return c.BackingStore.AddBackend(ctx, backend)
}

// ListBackends lists all of the backends.
func (c *cachingStore) ListBackends(ctx context.Context) ([]*types.Backend, error) {
